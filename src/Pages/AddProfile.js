        ...
        >
            ...
            <div class="col-md-2">
              <div class="form-check form-check-inline">
                <input
                  ...
                  value="option1"
                />
                <h6 class="form-check-h6" for="inlineRadio1">
                  Male
                </h6>
              </div>
            </div>
            ...
            <div class="col-md-2">
              <div class="form-check form-check-inline">
                <input
                  ...
                  value="option2"
                />
                <h6 class="form-check-h6" for="inlineRadio2">
                  Female
                </h6>
              </div>
            </div>
          ...
          <div>
            <button class="btn btn-
                primary btns">Save</button>
            <button class="btn btn-light" style={{ marginLeft: "20px" }}>
              Cancel
            </button>
          </div>
        </div>
